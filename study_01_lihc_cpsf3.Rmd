...
table(sample_cluster_tab$deseq2_clust, sample_cluster_tab$rpm)
table(sample_cluster_tab$deseq2_clust, sample_cluster_tab$edger)
table(sample_cluster_tab$rpm_clust, sample_cluster_tab$edger)
table(sample_cluster_tab$rpm40_clust, sample_cluster_tab$edger)
```
