...
```{r}
## Clusters
cluster_tab = data.frame(features)
bar = cutree(rpm_hm$hc_row, k=4)
bar
cluster_tab$rpm_clust = NA
cluster_tab[names(bar)[bar==1],"rpm_clust"] = "rpmA"
cluster_tab[names(bar)[bar==2],"rpm_clust"] = "rpmB"
cluster_tab[names(bar)[bar==3],"rpm_clust"] = "rpmC"
cluster_tab[names(bar)[bar==4],"rpm_clust"] = "rpmD"
```
...
bar
cluster_tab$deseq2_clust = NA
cluster_tab[names(bar)[bar==1],"deseq2_clust"] = "deseq2A"
cluster_tab[names(bar)[bar==2],"deseq2_clust"] = "deseq2B"
cluster_tab[names(bar)[bar==3],"deseq2_clust"] = "deseq2C"
cluster_tab[names(bar)[bar==4],"deseq2_clust"] = "deseq2D"
```
...
```{r results="verbatim"}
table(cluster_tab$rpm_clust, cluster_tab$deseq2_clust)
```
...
bar
cluster_tab$rpm40_clust = NA
cluster_tab[names(bar)[bar==1],"rpm40_clust"] = "rpm40A"
cluster_tab[names(bar)[bar==2],"rpm40_clust"] = "rpm40B"
cluster_tab[names(bar)[bar==3],"rpm40_clust"] = "rpm40C"
cluster_tab[names(bar)[bar==4],"rpm40_clust"] = "rpm40D"
```
...
```{r results="verbatim"}
table(cluster_tab$rpm40_clust, cluster_tab$deseq2_clust)
```
...
bar
cluster_tab$edger_clust = NA
cluster_tab[names(bar)[bar==1],"edger_clust"] = "edgerA"
cluster_tab[names(bar)[bar==2],"edger_clust"] = "edgerB"
cluster_tab[names(bar)[bar==3],"edger_clust"] = "edgerC"
cluster_tab[names(bar)[bar==4],"edger_clust"] = "edgerD"
```
...
```{r results="verbatim"}
table(cluster_tab$deseq2_clust, cluster_tab$edger)
table(cluster_tab$rpm_clust, cluster_tab$edger)
table(cluster_tab$rpm40_clust, cluster_tab$edger)
```

```{r, results='asis'}
rpm_deseq2_clust_table = table(cluster_tab$rpm_clust, cluster_tab$deseq2_clust)
rpm_edger_clust_table = table(cluster_tab$rpm_clust, cluster_tab$edger_clust)
edger_deseq2_clust_table = table(cluster_tab$edger_clust, cluster_tab$deseq2_clust)
rpm40_deseq2_clust_table = table(cluster_tab$rpm40_clust, cluster_tab$deseq2_clust)
rpm40_edger_clust_table = table(cluster_tab$rpm40_clust, cluster_tab$edger_clust)
